...
//  When joe.scope() is invoked, "this" is referencing Joe
// 2. What is "this" when joe.scopeArrow() is invoked?
//  When joe.scopeArrow() is invoked, "this" is referencing the Window because there is no code block encompassing it where "this" is defined, and so the next highest scope that defines "this" is used
// 3. Explain why "this" is different when an arrow function is used.
//  "This" is different when using an arrow function because arrow functions use the value of "this" that is defined within the next highest scope.  Without an arrow function, "this" would have to be defined within the scope.
