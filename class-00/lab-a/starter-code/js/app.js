...
function displayPics(){
  ...
  // Because const rando = makeRandom(); is declared inside the displayPics() codeblock and doesn't have global scope, this is why it says rando is not defined when trying to console log it.
  console.log(viewed);
